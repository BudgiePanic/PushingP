...
public class LineDrawerDemo implements Runnable {
    ...
    public void run() {
        ...
        LineDrawer.drawLine(0, 0, size-1, size-1, canvas, Colors.white);
        LineDrawer.drawLine(size-1, 0, 0, size-1, canvas, Colors.white);
        LineDrawer.drawLine(size/2, 0, size/2, size-1, canvas, Colors.white);
        LineDrawer.drawLine(0, size/2, size-1, size/2, canvas, Colors.white);
