...
public class AABBDemo implements Runnable {
    ...
    private final PinHoleCamera camera = new TimingWrapper(width, height, fov, View.makeViewMatrix(Tuple.makePoint(11f,5, 2f), Tuple.makePoint(11, 0, 8), Tuple.makePoint(0,1,0)));
